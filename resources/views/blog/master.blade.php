...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom position-fixed top-0 w-100">
    <div class="container">
        <a class="navbar-brand" href="{{ route('index') }}">
            <img src="{{ asset('images/images/cropped-logo.png') }}" style="height: 40px" class="me-1" alt="">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul id="menu-top-right-menu" class="navbar-nav ms-auto mb-2 mb-md-0 ">
                ...
                <li id="menu-item-16"
                    ...
                    <a href="{{ route('login') }}" class="nav-link {{ request()->url() ==  route('login') ? 'active':'' }}">Login</a>
                </li>
                        ...
                        <form action="">
                            <div class="d-flex search-box">
                                <input type="text" class="form-control flex-shrink-1 me-2 search-input"
                                       placeholder="Search Anything" name="search" required>
